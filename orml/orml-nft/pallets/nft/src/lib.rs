...
decl_storage! {
	...
	trait Store for Module<T: Trait> as TemplateModule {
		...
		NftClassId get(fn nft_class_id): map hasher(twox_64_concat) T::AccountId => T::ClassId;
		NftTokenMetaData get(fn user_nft_token_metadata):  map hasher(twox_64_concat) T::AccountId => orml_nft::CID;
	}
}
